...
urlpatterns = [
    #type
    path('types_view/', type.TypeView.as_view(), name="types"),
    ...
    path('update/', leave.UpdateLeaveView.as_view(), name="update"),
    path('delete/', leave.DeleteLeaveView.as_view(), name="delete"),
