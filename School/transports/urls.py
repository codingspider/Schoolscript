...
urlpatterns = [
    ...
    path('update_driver/', driver.DriverUpdateView.as_view(), name="update_driver"),
    path('delete_driver/', driver.DeleteDriverView.as_view(), name="delete_driver"),
    ...
    path('update_vehicle/', vehicle.VehicleUpdate.as_view(), name="update_vehicle"),
    path('delete_vehicle/', vehicle.DeleteVehicleView.as_view(), name="delete_vehicle"),
